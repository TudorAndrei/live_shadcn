defmodule LiveShadcnTools.Gen.NavigationMenu do
  ...
  A navigation menu is not a menu. Its trigger lives in a list item while its
  content is presented through a shared viewport. The generic menu recipe has
  one trigger and one popup, so it cannot represent that structure.
  """

  @doc "The module source for one navigation menu component."
  def module(_spec, opts) do
      ...
      def navigation_menu(assigns) do
        ...
        >
          <ul
            ...
            class={["cn-navigation-menu-list group flex flex-1 list-none items-center justify-center", @list_class]}
          >
