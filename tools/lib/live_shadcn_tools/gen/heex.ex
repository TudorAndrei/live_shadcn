defmodule LiveShadcnTools.Gen.Heex do
  ...
  @tag_attributes %{
    ...
    "button" => ~w(type value name formaction disabled),
    ...
    "input" =>
      ~w(type name value placeholder checked min max step minlength maxlength pattern readonly
         multiple autocomplete disabled required),
    "label" => ~w(for),
    "ol" => ~w(start reversed),
    ...
    "textarea" => ~w(name placeholder rows cols readonly wrap disabled required),
