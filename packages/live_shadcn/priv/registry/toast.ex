defmodule LiveShadcn.UI.Toast do
  ...
  @upstream_facts %{
    "jsx/ToastClose/class/0" =>
      "relative shrink-0 text-muted-foreground after:absolute after:-inset-2 after:content-[''] hover:text-foreground",
    "jsx/ToastContent/class/0" =>
      "flex h-full items-center gap-3 overflow-hidden p-4 transition-opacity duration-250 ease-[cubic-bezier(0.22,1,0.36,1)] data-behind:opacity-0 data-expanded:opacity-100",
    "jsx/ToastDescription/class/0" => "text-sm text-muted-foreground",
    "jsx/ToastIcon/class/2" =>
      "shrink-0 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
    "jsx/ToastList/class/0" => "flex min-w-0 flex-1 flex-col gap-1",
    "jsx/ToastTitle/class/0" => "text-sm font-medium",
    "jsx/ToastViewport/class/0" =>
  ...
  def toaster(assigns) do
    ...
    <div data-slot="toast-portal">
      <div
        ...
        aria-label={@label}
        class={[
          upstream_fact("jsx/ToastViewport/class/0"),
          (@class || "")
        ]}
      ...
      >
        ...
        >
          <div
            ...
            class={upstream_fact("jsx/ToastContent/class/0")}
            data-lb-style-target
          >
            <span
              data-slot="toast-icon"
              class={upstream_fact("jsx/ToastIcon/class/2")}
            >
              <LiveShadcn.Icon.icon name={icon(toast[:type])} />
            </span>

            <div class={upstream_fact("jsx/ToastList/class/0")}>
              <h2
                :if={toast[:title]}
              ...
              <p
                ...
                data-type={toast[:type]}
                class={upstream_fact("jsx/ToastDescription/class/0")}
              >
                {render_slot(toast)}
              </p>
            </div>
            ...
            <LiveShadcn.UI.Button.button
              ...
              data-type={toast[:type]}
              class={upstream_fact("jsx/ToastClose/class/0")}
            >
