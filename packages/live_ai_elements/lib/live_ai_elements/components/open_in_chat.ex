defmodule LiveAiElements.Components.OpenInChat do
  ...
  @upstream_facts %{
    "jsx/OpenInChatGPT/class/0" => "flex items-center gap-2",
    "jsx/OpenInChatGPT/class/1" => "shrink-0",
    "jsx/OpenInChatGPT/class/2" => "flex-1",
    "jsx/OpenInChatGPT/class/3" => "size-4 shrink-0"
  }
  ...
  def open_in_chat_gpt(assigns) do
    ...
    >
      ...
      <span class={upstream_fact("jsx/OpenInChatGPT/class/2")}>
        Open in ChatGPT
      </span>
      <LiveShadcn.Icon.icon name="external-link" class={upstream_fact("jsx/OpenInChatGPT/class/3")} />
      {render_slot(@inner_block)}
    </a>
    """
  end

  @doc "The `open_in_claude` part."
  ...
  def open_in_t3(assigns) do
    ...
    >
      <span class={upstream_fact("jsx/OpenInChatGPT/class/1")}><LiveShadcn.Icon.icon name="message-circle" /></span><span class={upstream_fact("jsx/OpenInChatGPT/class/2")}>Open in T3 Chat</span><LiveShadcn.Icon.icon
        name="external-link"
        class={upstream_fact("jsx/OpenInChatGPT/class/3")}
      />{render_slot(@inner_block)}
    </a>
    """
  end

  @doc "The `open_in_scira` part."
  attr(:query, :string, default: nil)
  attr(:class, :any, default: nil, doc: "Appended to the class string upstream renders.")
  attr(:rest, :global, include: ["data-slot", "href", "target", "rel", "download", "hreflang"])
  slot(:inner_block)
