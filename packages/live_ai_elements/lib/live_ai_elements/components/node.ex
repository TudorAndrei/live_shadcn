defmodule LiveAiElements.Components.Node do
  ...
  def node(assigns) do
    ...
    <div
      ...
      data-size={@size}
      class={[
        "cn-card group/card flex flex-col node-container relative size-full h-auto w-sm gap-0 rounded-md p-0",
        @class
      ]}
  ...
  def node_header(assigns) do
    ...
    <div
      ...
      class={[
        "cn-card-header group/card-header @container/card-header grid auto-rows-min items-start has-data-[slot=card-action]:grid-cols-[1fr_auto] has-data-[slot=card-description]:grid-rows-[auto_auto] gap-0.5 rounded-t-md border-b bg-secondary p-3!",
        @class
      ]}
      {Map.drop(@rest, [:"data-slot"])}
    >
  ...
  def node_content(assigns) do
    ...
    <div
      ...
      class={["cn-card-content p-3", @class]}
      {Map.drop(@rest, [:"data-slot"])}
    >
      {render_slot(@inner_block)}
    </div>
  ...
  def node_footer(assigns) do
    ...
    <div
      ...
      class={["cn-card-footer flex items-center rounded-b-md border-t bg-secondary p-3!", @class]}
      {Map.drop(@rest, [:"data-slot"])}
    >
      {render_slot(@inner_block)}
    </div>
